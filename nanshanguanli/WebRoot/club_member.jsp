...
<html> 
  <head>
	...
	<link rel="stylesheet" type="text/css"
		...
		<script type="text/javascript" src="myjs/club_member.js"></script>
  </head> 
   <body>
  		 <table id="datagrid"> 
		</table> 
		<div id="toolbar" style="padding: 5px">
			<a href="#" class="toolbar-btn" iconCls="icon-add" onclick="addMember()">添加社员</a>
			<a href="#" class="toolbar-btn" iconCls="icon-edit" onclick="updateMember()">更新信息</a>
			<a href="#" class="toolbar-btn" iconCls="icon-remove" onclick="deleteMember()">删除社员</a>
		...
		<form id="addform" name="addform" style="text-align: center;">
			...
			<p class="intext">
				所属社团：
				<input name="fromclubname" width="70px" id="a-fromclubname">
			</p>
			<p class="intext">
				联系电话：
		...
		<form id="updateform" style="text-align: center;">
			...
			<p class="intext">
				学　　号：
				<input name="memberstuid" maxlength="9" width="70px" disabled="disabled"
					id="u-memberstuid">
			</p>
			<p class="intext">
				性　　别：
			...
			<p class="intext">
				所属社团：
				<input name="fromclubname" width="70px" id="u-fromclubname">
			</p>
			<p class="intext">
				联系电话：
